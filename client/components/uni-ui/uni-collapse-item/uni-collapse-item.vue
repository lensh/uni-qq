<template>
	<view :class="{ 'uni-collapse-cell--disabled': disabled,'uni-collapse-cell--notdisabled': !disabled, 'uni-collapse-cell--open': isOpen,'uni-collapse-cell--hide':!isOpen }" class="uni-collapse-cell">
		<view class="uni-collapse-cell__title" @click="onClick">
			...
			<text class="uni-collapse-cell__title-text" v-if="!isIconLeft">{{ title }}</text>
			<!-- #ifdef MP-ALIPAY -->
			...
			<!-- #endif -->
			<text class="uni-collapse-cell__title-text" style="margin-left: 6rpx;" v-if="isIconLeft">{{ title }}</text>
			<slot name="right"/>
		</view>
